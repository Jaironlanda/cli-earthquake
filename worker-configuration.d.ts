/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d0f80bfb8626db55208abc4ebd3cbdb6)
...
interface __BaseEnv_Env {
	...
	PROTOMAPS_KEY: "";
	ADMIN_TOKEN: string;
	TERMINAL_HUB: DurableObjectNamespace<import("./src/index").TerminalHub>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TerminalHub";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PROTOMAPS_KEY" | "ADMIN_TOKEN">> {}
}
